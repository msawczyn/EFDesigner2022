...
namespace Sawczyn.EFDesigner.EFModel
{
   ...
   [DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"EFModel", typeof(EFModelEditorFactory))]
	...
	internal abstract partial class EFModelPackageBase : DslShell::AsyncModelingPackage
   {
      ...
      protected override object GetToolboxItemData(string itemId, DataFormats.Format format)
      {
		...
		{
			if (toolWindowType == typeof(EFModelExplorerToolWindow).GUID)
			{
				return this;
   }
...
namespace Sawczyn.EFDesigner.EFModel
{
	...
	/// </summary>
   [VSShell::ProvideMenuResource("1000.ctmenu", version: 48)]
