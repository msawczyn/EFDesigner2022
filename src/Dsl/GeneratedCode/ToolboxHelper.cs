...
namespace Sawczyn.EFDesigner.EFModel
{
   ...
   public abstract class EFModelToolboxHelperBase
   {
      ...
      /// item filters.
      /// </remarks>
      public const string ToolboxFilterString = "EFModel.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify ModelClass element tool.
      /// </summary>
      public const string ModelClassFilterString = "ModelClass.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify UnidirectionalAssociation connector tool.
      /// </summary>
      public const string UnidirectionalAssociationFilterString = "UnidirectionalAssociation.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify BidirectionalAssociation connector tool.
      /// </summary>
      public const string BidirectionalAssociationFilterString = "BidirectionalAssociation.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify Generalization connector tool.
      /// </summary>
      public const string GeneralizationFilterString = "Generalization.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify Comment element tool.
      /// </summary>
      public const string CommentFilterString = "Comment.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify CommentLink connector tool.
      /// </summary>
      public const string CommentLinkFilterString = "CommentLink.4.2";
      /// <summary>
      /// Toolbox item filter string used to identify Enumeration element tool.
      /// </summary>
      public const string EnumerationFilterString = "Enumeration.4.2";
