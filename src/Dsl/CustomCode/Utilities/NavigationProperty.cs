namespace Sawczyn.EFDesigner.EFModel
{
   ...
   public class NavigationProperty
   {
      ...
      public bool IsCollection
      {
         get
         {
            /*Cardinality == Multiplicity.OneMany || */
         ...
         return new NavigationProperty
                {
                   ...
                   BackingFieldName = association.SourceAutoProperty
                                         ? null
                                         : association.SourceBackingFieldName,
                   BackingFieldPropertyAccessMode = association.SourceAutoProperty
                                                       ? null
                                                       : association.SourcePropertyAccessMode.ToString(),
                   ImplementNotify = association.SourceImplementNotify,
                   FKPropertyName = association.SourceRole == EndpointRole.Principal
                                       ? association.FKPropertyName
                                       : null,
                   PointsToSource = true
                };
      }
         ...
         return new NavigationProperty
                {
                   ...
                   BackingFieldName = association.TargetAutoProperty
                                         ? null
                                         : association.TargetBackingFieldName,
                   BackingFieldPropertyAccessMode = association.TargetAutoProperty
                                                       ? null
                                                       : association.TargetPropertyAccessMode.ToString(),
                   ImplementNotify = association.TargetImplementNotify,
                   FKPropertyName = association.TargetRole == EndpointRole.Principal
                                       ? association.FKPropertyName
                                       : null,
                   PointsToTarget = true
                };
