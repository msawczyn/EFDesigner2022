...
namespace Sawczyn.EFDesigner.EFModel
{
   public class PropertyAccessModeTypeConverter : TypeConverterBase
   {
      ...
      {
         return (destinationType == typeof(PropertyAccessMode)) || base.CanConvertTo(context, destinationType);
      }
      ...
      public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
      {
         ...
         if (store != null)
         {
            ...
            {
               values.AddRange(new[] {"Field", "FieldDuringConstruction", "Property"});
            }
            else
            {
               values.AddRange(new[] {"Field", "FieldDuringConstruction", "PreferField", "PreferFieldDuringConstruction", "PreferProperty", "Property"});
            }
         }
