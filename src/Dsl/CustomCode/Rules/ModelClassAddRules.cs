...
namespace Sawczyn.EFDesigner.EFModel
{
   ...
   internal class ModelClassAddRules : AddRule
   {
      ...
      public override void ElementAdded(ElementAddedEventArgs e)
      {
         ...
         Trace.WriteLine($"ModelClassAddRules::ElementAdded: {element.Name}: element.AllIdentityAttributes.Any() = {element.AllIdentityAttributes.Any()}, element.IsDependentType = {element.IsDependentType}, element.IsKeylessType() =  {element.IsKeylessType()}, (element.IsDependentType || element.IsKeylessType()) = {element.IsDependentType || element.IsKeylessType()}");

         // don't use element.IsKeylessType() here because identity attributes are not set yet
